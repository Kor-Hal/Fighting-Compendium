...
-- Combination Types
INSERT INTO CombinationTypes (symbol) VALUES (',');
INSERT INTO CombinationTypes (symbol) VALUES ('~');
INSERT INTO CombinationTypes (symbol) VALUES ('+');
...
-- Moves
INSERT INTO Moves (idCharacter) VALUES ((SELECT C.idCharacter FROM Characters C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.name =  'Rig'));

-- Inputs
INSERT INTO Inputs (idState, idCommand, idCombinationType, idMove, ordering) VALUES (NULL, (SELECT C.idCommand FROM Commands C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.notation = 'K'), (SELECT idCombinationType FROM CombinationTypes WHERE symbol = ','), (SELECT M.idMove FROM Moves M JOIN Characters C ON M.idCharacter = C.idCharacter WHERE C.name = 'Rig'), 1);
INSERT INTO Inputs (idState, idCommand, idCombinationType, idMove, ordering) VALUES (NULL, (SELECT C.idCommand FROM Commands C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.notation = 'K'), (SELECT idCombinationType FROM CombinationTypes WHERE symbol = '~'), (SELECT M.idMove FROM Moves M JOIN Characters C ON M.idCharacter = C.idCharacter WHERE C.name = 'Rig'), 2);
INSERT INTO Inputs (idState, idCommand, idCombinationType, idMove, ordering) VALUES (NULL, (SELECT C.idCommand FROM Commands C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.notation = '4'), (SELECT idCombinationType FROM CombinationTypes WHERE symbol = ','), (SELECT M.idMove FROM Moves M JOIN Characters C ON M.idCharacter = C.idCharacter WHERE C.name = 'Rig'), 3);
INSERT INTO Inputs (idState, idCommand, idCombinationType, idMove, ordering) VALUES ((SELECT S.idState FROM States S JOIN Characters C ON S.idCharacter = C.idCharacter JOIN Games G ON S.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.name = 'Rig' AND S.notation = 'TLC'), (SELECT C.idCommand FROM Commands C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.notation = 'K'), (SELECT idCombinationType FROM CombinationTypes WHERE symbol = '~'), (SELECT M.idMove FROM Moves M JOIN Characters C ON M.idCharacter = C.idCharacter WHERE C.name = 'Rig'), 4);
INSERT INTO Inputs (idState, idCommand, idCombinationType, idMove, ordering) VALUES (NULL, (SELECT C.idCommand FROM Commands C JOIN Games G ON C.idGame = G.idGame WHERE G.name = 'Dead or Alive 5 Ultimate' AND C.notation = 'K'), (SELECT idCombinationType FROM CombinationTypes WHERE symbol = '+'), (SELECT M.idMove FROM Moves M JOIN Characters C ON M.idCharacter = C.idCharacter WHERE C.name = 'Rig'), 5);
